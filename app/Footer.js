...
const Footer = () => {
  return (
    <footer>
      <div className=" border-t  pt-8 relative  px-4 lg:px-0  bg-gray-950 text-white">
          ...
          {/* <div className="sm:max-w-[300px] sm:mx-auto sm:col-span-2 lg:col-span-1  mx-auto">
            ...
            <div className="space-y-8">
              <p className="text-gray-50 pb-3 text-justify">
                ...
                Perferendis architecto non unde expedita laudantium fugit
                quibusdam porro fuga consequatur recusandae sunt obcaecati
                aperiam, dolore earum quas pariatur perspiciatis vero ullam?
              </p>
            </div>
          </div>
